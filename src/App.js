...
export default function App() {
  ...
  return (
    <div className='App bg-darkmode_black flex flex-col justify-between min-h-screen'>
      ...
      <Context.Provider value={{ allBands, setAllBands }}>
        <div className='px-8 md:px-14 lg:px-20'>
          <Routes>
            ...
            <Route path='/shop' element={<Shop></Shop>}>
              ...
              <Route
                path='/shop/tickets'
                element={<TicketForm></TicketForm>}></Route>
              <Route path='/shop/tents' element={<TentForm></TentForm>}></Route>
              <Route
                path='/shop/campground'
                element={<CampgroundForm></CampgroundForm>}></Route>
              <Route
                path='/shop/personal-info'
                element={<PersonalInfo></PersonalInfo>}></Route>
              <Route path='/shop/basket' element={<Basket></Basket>}></Route>
            </Route>
            <Route
              path='/confirmation'
              element={<Confirmation></Confirmation>}></Route>
