...
function CampgroundsMap(props) {
    ...
    const activeClassString = "transition-all duration-300 origin-center scale-110";
    const nonActiveClass = "transition-all duration-300 origin-center";
  ...
  return (
    <svg version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	 viewBox="-20 -30 527 559" className='max-h-full max-w-full'>
        <g>
            <path fill="#E19F54" d="M185.6,75.7l72.7-66.8L379,65.5l-87.6,66.3l-96.9-8.3L185.6,75.7z"/>
