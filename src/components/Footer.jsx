...
function Footer() {
  return (
    ...
    <div className="flex flex-col justify-between lg:flex-row gap-10 lg:gap-0">
            <a href=""><img src={process.env.PUBLIC_URL + "/LogoText.svg"} className="mr-3 h-12" alt="Ragnarock Logo" /></a>
            <PrimaryButton caption="Get your tickets now" onClick={"/shop"}></PrimaryButton>
            <div className='flex'>
                <AiFillFacebook className='text-white h-10 w-auto hover:fill-accent_yellow cursor-pointer' alt="Facebook logo"/>
                <AiFillInstagram className='text-white h-10 w-auto hover:fill-accent_yellow cursor-pointer' alt="Instagram logo"/>
            </div>
        </div>
