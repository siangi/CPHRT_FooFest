...
export default function Home() {
  return ( 
    <>
      ...
      <img src={process.env.PUBLIC_URL + "/images/landingpage_image3.png"} alt="crowd at a festival" className='object-cover object-center object-fit mt-24 lg:mt-0 hidden md:block'/>
